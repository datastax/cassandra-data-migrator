...
RUN mkdir -p /assets/ && cd /assets && \
    ...
    curl -OL https://archive.apache.org/dist/spark/spark-3.5.7/spark-3.5.7-bin-hadoop3-scala2.13.tgz && \
...
ENV PATH="${PATH}:/assets/dsbulk/bin/:/assets/cqlsh-astra/bin/:/assets/spark-3.5.7-bin-hadoop3-scala2.13/bin/"
